...
(function($, document) {
	...
	var panelBuffer = '<div class="mui-poppicker picker-container">\
		<div class="mui-poppicker-header">\
			<button class="mui-btn button mui-poppicker-btn-cancel">取消</button>\
			<button class="mui-btn button mui-poppicker-btn-ok">确定</button>\
...
(function($, document) {
	...
	var domBuffer = '<div class="mui-dtpicker picker-container" data-type="datetime">\
		<div class="mui-dtpicker-header">\
			<button data-id="btn-cancel" class="button">取消</button>\
			<button data-id="btn-ok" class="button">确定</button>\
		</div>\
